...
public class ExcepcionNumero extends Exception {
    ...
    public static void main(String[] args) {
        ...
        try{
            System.out.println("indique un nivel");
        ...
        do{
            try{
            System.out.println("indique un letra");
        ...
        public static String getPalabraAleatoria(int nivel){
            ...
            String[] palabras_12 = {"bachillerato" , "habitacion" , "laboratorio"};
        ...
        public static void validaNumero(String letra) throws ExcepcionNumero{
         try{
             ...
             throw new ExcepcionNumero("El valor es un numero");
